...
entry:
  ...
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr nonnull @1, i32 3, ptr nonnull @.omp_outlined., ptr nonnull %i, ptr nonnull %e, ptr nonnull %f)
...
define internal void @.omp_outlined.(ptr noalias nocapture %.global_tid., ptr noalias nocapture %.bound_tid., ptr nocapture noundef nonnull align 4 dereferenceable(4) %i, ptr nocapture noundef nonnull align 4 dereferenceable(4) %e, ptr nocapture noundef nonnull align 4 dereferenceable(4) %f) #2 {
entry:
  ret void
}
...
entry:
  ...
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr nonnull @1, i32 3, ptr nonnull @.omp_outlined., ptr nonnull %i.i, ptr nonnull %e.i, ptr nonnull %f.i)
