; ModuleID = '../p_example2.cpp'
source_filename = "../p_example2.cpp"
...
@str = private unnamed_addr constant [20 x i8] c"OpenMP : Example 1 \00", align 1
...
define dso_local noundef i32 @_Z3foov() local_unnamed_addr #2 {
entry:
...
define internal void @.omp_outlined.(ptr noalias nocapture noundef readonly %.global_tid., ptr noalias nocapture readnone %.bound_tid.) #3 {
entry:
