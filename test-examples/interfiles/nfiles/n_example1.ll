...
entry:
  ...
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @1, i32 1, ptr @.omp_outlined., ptr %d)
...
define internal void @.omp_outlined.(ptr noalias noundef %.global_tid., ptr noalias noundef %.bound_tid., ptr noundef nonnull align 4 dereferenceable(4) %d) #2 {
entry:
  ...
  %0 = load ptr, ptr %d.addr, align 8, !tbaa !10
  ...
  store i32 %add1, ptr %0, align 4, !tbaa !6
  ret void
}
