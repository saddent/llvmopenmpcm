...
@.str = private unnamed_addr constant [21 x i8] c"OpenMP : Example 1 \0A\00", align 1
...
entry:
  ...
  %inc = add nsw i32 %1, 1
  store i32 %inc, ptr %a, align 4, !tbaa !6
...
define internal void @.omp_outlined.(ptr noalias noundef %.global_tid., ptr noalias noundef %.bound_tid.) #2 {
entry:
