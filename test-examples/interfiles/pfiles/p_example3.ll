...
entry:
  ...
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @1, i32 5, ptr @.omp_outlined., ptr %i, ptr %a, ptr %b, ptr %e, ptr %f)
...
define internal void @.omp_outlined.(ptr noalias noundef %.global_tid., ptr noalias noundef %.bound_tid., ptr noundef nonnull align 4 dereferenceable(4) %i, ptr noundef nonnull align 4 dereferenceable(4) %a, ptr noundef nonnull align 4 dereferenceable(4) %b, ptr noundef nonnull align 4 dereferenceable(4) %e, ptr noundef nonnull align 4 dereferenceable(4) %f) #2 {
entry:
  ...
  %4 = load ptr, ptr %f.addr, align 8, !tbaa !10
